...
def create_python_env_and_run_script():
    ...
    allowed_classes = [0]
    label_dir = f"{home_directory}/Akhil_yolo/Research/BraTS21/val"  # adjust if needed
    ...
    # Run training
    run_script_cmd = f'{envpath}/bin/python3.9 {home_directory}/Akhil_yolo/Research/train.py'
